...
class EventListModel {
  ...
  factory EventListModel.fromJson(String str) => EventListModel.fromMap(json.decode(str));
...
enum Role { INKER, PENCILER, WRITER, COLORIST, LETTERER, PENCILLER_COVER, PENCILLER, EDITOR, PENCILER_COVER, ARTIST, INKER_COVER, ROLE_COLORIST, ROLE_PENCILLER, ROLE_LETTERER, COLORIST_COVER, OTHER, PAINTER_COVER }
...
enum ItemType { COVER, INTERIOR_STORY, EMPTY, TEXT_ARTICLE, TABLE_OF_CONTENTS, PINUP, CREDITS, PROMO, LETTERS, AD, FEATURE, PIN_UP, STATEMENT_OF_OWNERSHIP, TEXT_STORY }
