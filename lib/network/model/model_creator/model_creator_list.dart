...
class CreatorListModel {
  ...
  factory CreatorListModel.fromJson(String str) =>
      CreatorListModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CreatorListModel.fromMap(Map<String, dynamic> json) =>
      CreatorListModel(
        code: json["code"],
        status: json["status"],
...
enum MiddleName { EMPTY, PAINE }

final middleNameValues =
    EnumValues({"": MiddleName.EMPTY, "Paine": MiddleName.PAINE});
...
enum ItemType { INTERIOR_STORY, COVER, EMPTY, RECAP }
