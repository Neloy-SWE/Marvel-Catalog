...
import '../../network/request/provider/provider_series/provider_series_details.dart';
...
class SeriesDetailsScreen extends ConsumerStatefulWidget {
  ...
  const SeriesDetailsScreen({Key? key, required this.id}) : super(key: key);
...
class _SeriesDetailsScreenState extends ConsumerState<SeriesDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    final data = ref.watch(seriesDetailsProvider(widget.id));
    return Scaffold(
      appBar: AppBar(
